...
class CustomAgent(Agent):
    def __init__(
        ...
        # Initialize basic parameters that are supported by browser_use.agent.service.Agent
        # From inspection of the Agent.__init__ in browser_use, passing only parameters it knows about
        super(CustomAgent, self).__init__(
            ...
            override_system_message=None,  # Not using this
            extend_system_message=None,    # Not using this 
        ...
        # Store parameters not passed to parent
        self.add_infos = add_infos
        
        # Save our custom state if not using parent's
        if not injected_agent_state:
